@include("account.dashboard.layouts.shared.includes.main")

<head>
    @yield('title')
    @include("account.dashboard.layouts.shared.includes.head-css")
    @yield('styles')
</head>

<body data-bs-spy="scroll" data-bs-target="#navbar-example">
    <div class="layout-wrapper landing">
        @include("account.dashboard.layouts.shared.includes.main-site.navigation")
        <div class="vertical-overlay" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent.show"></div>
        @yield('content')
        @include("account.dashboard.layouts.shared.includes.main-site.footer")
    </div>
    @include("account.dashboard.layouts.shared.includes.vendor-scripts")
