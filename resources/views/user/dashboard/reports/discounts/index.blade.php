...
@section('title')
@include("dashboard.layouts.shared.includes.title-meta", ["title" => __("Discounts")])
@endsection

@section('page-title')
@include("dashboard.layouts.shared.includes.page-title", ["pagetitle" => __("Discounts"), "title" => __("Discounts")])
@endsection
...
<div class="row">
    <div class="col">
        <div class="h-100">
            <div class="row">
                @foreach(\App\Models\Discount::STATUSES as $status => $statusLabel)
                <!-- Total {{ $statusLabel }} discounts Card -->
            ...
            <div class="card-header">
                ...
                <div class="row g-4 mb-3">
                    <div class="col-sm-auto">
                        <div>
                            <a href="{{ route('user.dashboard.reports.discounts.create') }}" class="btn btn-success add-btn" id="create-btn">
                ...
                <div class="table-responsive table-card">
                    <table class="table table-nowrap table-striped-columns mb-3">
                        ...
                        <tbody>
                            ...
                            <form id="form{{ $discount->id }}" action="{{ route('user.dashboard.reports.discounts.destroy', $discount->id) }}" method="post" class="hidden">
                                @csrf
                                @method('delete')
                            </form>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                            <a href="{{ route('user.dashboard.reports.discounts.edit', $discount->id) }}" class="btn btn-icon btn-primary edit-item-btn" title="{{__('Edit')}}"><i class="bx bx-edit"></i></a>
                                        </div>
                                        <div class="show">
                                            <a href="{{ route('user.dashboard.reports.discounts.show', $discount->id) }}" class="btn btn-icon btn-info edit-item-btn" title="{{__('Show')}}"><i class="ri-eye-line"></i></a>
                                        </div>
                                        <div class="remove">
                                            <button class="btn btn-icon btn-danger remove-item-btn" title="{{__('Delete')}}" data-id="{{ $discount->id }}"><i class="bx bx-trash"></i></button>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="d-flex justify-content-center">
                        <x-dashboard.pagination :model="$discounts" />
                    </div>
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
