...
@section('title')
@include("dashboard.layouts.shared.includes.title-meta", ["title" => __("Edit Order")])
@endsection

@section('page-title')
@include("dashboard.layouts.shared.includes.page-title", ["pagetitle" => __("Orders"), "title" => __("Edit Order")])
@endsection
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user.dashboard.reports.orders.update', $order->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="mb-3">
                                ...
                                <select required class="form-select" id="status_id" name="status_id">
                                    ...
                                    <option value="{{ $id }}" {{ old('status_id', $order->status_id) == $id ? 'selected' : '' }}>{{ __($name) }}</option>
                                    @endforeach
                                </select>
                                @error('status_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-20px">
                            ...
                            <select name="delivery_address[country_id]" id="country_id" value="{{ old('delivery_address.country_id', $order->deliveryAddress->country_id) }}" class="input-small form-select" required>
