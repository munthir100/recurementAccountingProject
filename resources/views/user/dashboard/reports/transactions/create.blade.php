...
@section('title')
@include("dashboard.layouts.shared.includes.title-meta", ["title" => __("Create Transaction")])
@endsection

@section('page-title')
@include("dashboard.layouts.shared.includes.page-title", ["pagetitle" => __("Transactions"), "title" => __("Create Transaction")])
@endsection
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user.dashboard.reports.transactions.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <select required class="form-select @error('transaction_type_id') is-invalid @enderror" id="transaction_type_id" name="transaction_type_id">
                                    ...
                                    <option value="{{$transactionType->id}}" {{ old('transaction_type_id') == $transactionType->id ? 'selected' : '' }}>{{__($transactionType->name)}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="date" class="form-control @error('date') is-invalid @enderror" id="date" name="date" value="{{ old('date') }}">
                                @error('date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <select required class="form-select" id="status_id" name="status_id">
                                    ...
                                    <option value="{{ $id }}" {{ old('status_id') == $id ? 'selected' : '' }}>{{ __($name) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <select required class="form-select" id="transactionable_type" name="transactionable_type">
                                    ...
                                    <option value="{{ $modelPath }}">{{ __($modelName) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="number" class="form-control @error('transactionable_id') is-invalid @enderror" id="transactionable_id" name="transactionable_id" value="{{ old('transactionable_id') }}" placeholder="{{ __("Enter Transaction Category ID") }}">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" placeholder="{{ __("Enter description") }}">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
