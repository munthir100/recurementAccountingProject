...
@section('title')
@include("dashboard.layouts.shared.includes.title-meta", ["title" => __("Create Contract")])
@endsection

@section('page-title')
@include("dashboard.layouts.shared.includes.page-title", ["pagetitle" => __("Contracts"), "title" => __("Create Contract")])
@endsection
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user.dashboard.reports.contracts.store') }}" method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="date" class="form-control @error('start_date') is-invalid @enderror" id="start_date" name="start_date" value="{{ old('start_date') }}">
                                @error('start_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location') }}" placeholder="{{ __("Enter location") }}">
                                @error('location')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control @error('renewal_terms') is-invalid @enderror" id="renewal_terms" name="renewal_terms" value="{{ old('renewal_terms') }}" placeholder="{{ __("Enter renewal terms") }}">
                                @error('renewal_terms')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <select required class="form-select" id="contractable_type" name="contractable_type">
                                    ...
                                    <option value="/App/Models/Account::class">Account</option>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="number" class="form-control @error('contractable_id') is-invalid @enderror" id="contractable_id" name="contractable_id" value="{{ old('contractable_id') }}" placeholder="{{ __("Enter contractable ID") }}">
