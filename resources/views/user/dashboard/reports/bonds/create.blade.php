...
@section('title')
@include("dashboard.layouts.shared.includes.title-meta", ["title" => __("Create Bond")])
@endsection

@section('page-title')
@include("dashboard.layouts.shared.includes.page-title", ["pagetitle" => __("Bonds"), "title" => __("Create Bond")])
@endsection
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user.dashboard.reports.bonds.store') }}" method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="number" class="form-control @error('interest_rate') is-invalid @enderror" id="interest_rate" name="interest_rate" value="{{ old('interest_rate') }}" placeholder="{{ __("Enter interest rate") }}">
                                @error('interest_rate')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="date" class="form-control @error('maturity_date') is-invalid @enderror" id="maturity_date" name="maturity_date" value="{{ old('maturity_date') }}">
                                @error('maturity_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control @error('issuer') is-invalid @enderror" id="issuer" name="issuer" value="{{ old('issuer') }}" placeholder="{{ __("Enter issuer") }}">
                                @error('issuer')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input required type="date" class="form-control @error('date_of_issue') is-invalid @enderror" id="date_of_issue" name="date_of_issue" value="{{ old('date_of_issue') }}">
                                @error('date_of_issue')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
