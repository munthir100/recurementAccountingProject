        ...
        <div class="card">
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <a data-bs-toggle="modal" data-bs-target="#addOffice" class="btn btn-soft-info">
                ...
                <div class="table-responsive table-card">
                    <table class="table table-nowrap table-striped-columns mb-3">
                        ...
                        <tbody>
                            ...
                            <form id="form{{ $office->id }}" action="{{ route('user.dashboard.offices.destroy', $office->id) }}" method="post" class="hidden">
                                @csrf
                                @method('delete')
                            </form>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                            <a href="{{ route('user.dashboard.offices.edit', $office->id) }}" class="btn btn-icon btn-primary edit-item-btn" title="{{__('Edit')}}"><i class="bx bx-edit"></i></a>
                                        </div>
                                        <div class="remove">
                                            <button class="btn btn-icon btn-danger remove-item-btn" title="{{__('Delete')}}" data-id="{{ $office->id }}"><i class="bx bx-trash"></i></button>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <!-- Delete Modal -->
                            <div class="modal fade" id="deleteModal{{ $office->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $office->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-danger" onclick="event.preventDefault(); document.getElementById('form{{ $office->id }}').submit();">
                                                {{ __("Delete") }}</button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="d-flex justify-content-center">
                        <x-dashboard.pagination :model="$offices" />
                    </div>
                    <div class="modal fade" id="addOffice" tabindex="-1" aria-labelledby="addOfficeLabel">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="sidebar-span" id="addOfficeLabel">{{ __("Create Office") }}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
