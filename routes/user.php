...
use App\Http\Controllers\User\Dashboard\ActivityController;
...
use App\Http\Controllers\User\Dashboard\Settings\ServiceController;
    ...
    Route::prefix('dashboard')->name('dashboard.')->group(function () {
        ...
        Route::prefix('settings')->name('settings.')->group(function () {
            ...
            Route::prefix('siteSettings')->name('siteSettings.')->group(function () {
                ...
                Route::get('genralData', [SiteSettingsController::class, 'getGenralData'])->name('genralData');
                Route::put('getGenralData/update', [SiteSettingsController::class, 'updateGenralData'])->name('genralData.update');
                ...
                Route::prefix('update')->name('update.')->group(function () {
                    Route::put('topBar', [SiteSettingsController::class, 'updateTopBar'])->name('topBar');
                    Route::put('banner', [SiteSettingsController::class, 'updateBanner'])->name('banner');
                });
            });
        });
